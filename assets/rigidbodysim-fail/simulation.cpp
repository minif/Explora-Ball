...
int Simulation::isCollidingWithObject(Object* self, colisionInfo (&col)[MAXOBJECTCOLLISIONS]) {
	/*
	This is called by an object after it moves.
	This function returns an Object that is colliding with the requesting object
	or null if nothing is colliding. The calling object puts itself as the argument.
	*/
